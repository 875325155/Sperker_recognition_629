...
# 此为log记录器
class Logger(object):
    def __init__(self, fileN="Voxforge_ssc.log"):
...
def test1(take):
    ...
    if take == 1:
        ...
        # 得到mfcc
        mfcc_feat = Spectral_Subband_Centroids.extract_features(sig, rate)
        ...
        for path in file_paths:
            ...
            vector = Spectral_Subband_Centroids.extract_features(audio, sr)
