...
# 此为log记录器
class Logger(object):
    def __init__(self, fileN="Voxforge_lfe.log"):
...
def test1(take):
    ...
    if take == 1:
        ...
        # 得到mfcc
        mfcc_feat = Log_Filterbank_Energies.extract_features(sig, rate)
        ...
        for path in file_paths:
            ...
            vector = Log_Filterbank_Energies.extract_features(audio, sr)
