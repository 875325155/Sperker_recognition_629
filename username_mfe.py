...
# 此为log记录器
class Logger(object):
    def __init__(self, fileN="Voxforge_mfe.log"):
...
def test1(take):
    ...
    if take == 1:
        ...
        # 得到mfcc
        mfcc_feat = Mel_filterbank_energy_features.extract_features(sig, rate)
        ...
        for path in file_paths:
            ...
            vector = Mel_filterbank_energy_features.extract_features(audio, sr)
